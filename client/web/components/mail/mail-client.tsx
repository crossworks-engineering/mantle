...
export function MailClient({
  ...
  return (
    ...
    <div className="fixed inset-x-0 bottom-0 top-[var(--top-bar-h)] z-10 overflow-hidden bg-background transition-[left,right] duration-200 ease-in-out md:left-[var(--nav-w)] lg:right-[var(--activity-w)]">
