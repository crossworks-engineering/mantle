...
export function DemoFontShowcase() {
  return (
    <Card className="flex flex-1 flex-col">
      ...
      {/* No inner ScrollArea: the sticky sidebar column this card lives in is
          already the scroll container — a second scrollbar inside the card is
          exactly the double-scroll this used to produce. The card sizes to
          its content and the COLUMN scrolls. */}
      <CardContent>
