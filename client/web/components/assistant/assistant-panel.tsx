...
export function AssistantPanel() {
  ...
  return (
    <div
      className={cn(
        'fixed inset-x-0 bottom-0 top-[var(--top-bar-h)] z-20 bg-background transition-[left,right,width] duration-200 ease-in-out md:left-[var(--nav-w)] lg:right-[var(--activity-w)]',
