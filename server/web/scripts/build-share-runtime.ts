...
// ── 4. Draw render island (draw snapshots inside the browser sidecar) ────────
...
// the real renderer — a self-hosted browser-side bundle. Imports only
...
console.log(`share-runtime: styles.css + islands.js + katex + draw-render → ${outDir}`);
