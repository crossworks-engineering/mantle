 ...
 *
 * Usage:
 *   ALLOWED_USER_ID=<uuid> pnpm -C server/web eval:runs
 *   ALLOWED_USER_ID=<uuid> pnpm -C server/web eval:runs --model=google/gemini-3.1-flash-lite
 *   ALLOWED_USER_ID=<uuid> pnpm -C server/web eval:runs --case=fabricated-verification
 *   ALLOWED_USER_ID=<uuid> pnpm -C server/web eval:runs --max-tokens=4000
 *   ALLOWED_USER_ID=<uuid> pnpm -C server/web eval:runs --baseline=scripts/eval/runs-audit-last-run.json
 *   ALLOWED_USER_ID=<uuid> pnpm -C server/web eval:runs --json
 *
