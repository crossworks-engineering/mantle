 ...
 *  narrowly — the asset token is accepted for NOTHING else. `/api/export/`
 *  is the download-anchor export surface: generated bytes rather than stored
 *  ones, but the same can't-carry-a-bearer link shape. */
