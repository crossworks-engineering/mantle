...
| Piece | Path |
|---|---|
| Route → topic map | `packages/web-ui/src/layout/help-topics.ts` |
| Content loader + frontmatter parser | `server/web/lib/help.ts` |
| API | `server/web/app/api/help/[topic]/route.ts` |
| Footer launcher | `client/web/components/help/help-launcher.tsx` |
| The rail | `client/web/components/help/help-rail.tsx` |
| Rail body (lazy) | `client/web/components/help/help-rail-body.tsx` |
| Open/close state | `client/web/components/help/help-rail-context.tsx` |
