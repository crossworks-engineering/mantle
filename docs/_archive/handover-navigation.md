...
[Location](_archive/handover-companion-location.md)._
...
- **Nothing to build.** No new endpoint, no new request fields, no new render
  ...
  [Location handover](_archive/handover-companion-location.md) describes.
...
- Directions HTTP tool + skill registration: `server/web/lib/system-manifest/manifest.ts`
- `route_map` builtin (Static Images → image artifact): `packages/tools/src/builtins-locations.ts`
- `navigation` skill body: `server/web/lib/system-manifest/prompts.ts`
...
- Location foundation this builds on: [`handover-companion-location.md`](_archive/handover-companion-location.md)
- Backfill onto an existing brain: `pnpm -C server/web seed:location`
