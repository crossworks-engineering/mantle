...
- Ingestion: `server/web/app/api/assistant/turn/route.ts` → `server/web/lib/assistant.ts`
...
- Agent skill: `location_awareness` (`server/web/lib/system-manifest/prompts.ts`)
