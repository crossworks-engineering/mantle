...
> lives in [draw-plan.md](_archive/draw-plan.md); this document is about checking
...
expected rebase surface: `jackdaw/components/export/export-menu.tsx`,
`jackdaw/package.json`, `server/web/app/api/export/[id]/route.ts`. After
...
1. Read [draw-plan.md](_archive/draw-plan.md) §2 (constraints) and §8 (kill
