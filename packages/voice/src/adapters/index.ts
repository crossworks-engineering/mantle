...
import { openrouterTtsAdapter } from './openrouter-tts';
import { openrouterSttAdapter } from './openrouter-stt';
...
registerTtsAdapter(openrouterTtsAdapter);
...
registerSttAdapter(openrouterSttAdapter);
...
registerImageGenAdapter(openrouterImageAdapter);
