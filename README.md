...
[![node](https://img.shields.io/badge/node-%E2%89%A526-5fa04e?logo=nodedotjs&logoColor=white)](./package.json)
[![typescript](https://img.shields.io/github/languages/top/crossworks-engineering/mantle?logo=typescript&logoColor=white)](./tsconfig.base.json)
[![postgres](https://img.shields.io/badge/Postgres-18%20%2B%20pgvector-336791?logo=postgresql&logoColor=white)](./docs/architecture.md)
[![self-hosted](https://img.shields.io/badge/runtime-self--hosted%2C%20no%20SaaS-0b7285)](./docs/self-hosting.md)
...
Counted from this tree by [`scripts/readme-stats.mjs`](./scripts/readme-stats.mjs)
(`pnpm readme:stats`), refreshed on every release, so it's either current or
provably stale, never a number someone typed once.

<!-- stats:start -->
<!-- Generated by `pnpm readme:stats` — counted from the tree, not typed by hand. -->

![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-178%2C864-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C515%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-153-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-211-6b4fbb)
![docs](https://img.shields.io/badge/docs-119%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-216-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **178,864** lines in 1,138 files |
| 🧪 &nbsp;Test suite | **3,515+** cases declared in 309 files |
| ⚖️ &nbsp;Test weight | 50,297 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,310 |
| 🐘 &nbsp;SQL migrations | 153, replayed in order on every boot |
| 📚 &nbsp;Docs | 119 engineering docs, 77 user-guide pages, 224 changelog entries (55,644 lines) |
...
| | |
| --- | --- |
| 🤖 &nbsp;Agents | 13 (your assistant + its specialists) |
| 🧠 &nbsp;Skills | 20 composable behaviours |
| 🧰 &nbsp;Built-in tools | 211, granted in 55 tool groups |
| ⚙️ &nbsp;Background AI workers | 12 (extract, summarise, reflect, read, see, speak…) |
| 💾 &nbsp;Datastores | **1** (Postgres — vectors, graph, FTS, queues, realtime, auth) |
| 🧊 &nbsp;Idle footprint | ~2.5 GB RAM, whole stack |

**Velocity** — v0.232.42, 2,698 commits and 216 releases since 2026-05-14 (101 days, ~26.7 commits/day).

```
commits/week, last 15 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▆▄▄   peak 334
```
...
**Operations & trust**
- [`scripts.md`](./docs/scripts.md), every script in the repo + the docker compose commands under them: dev stack, worktrees, dump/restore, install/update, maintenance + seeds, codegen, hooks, CI.
