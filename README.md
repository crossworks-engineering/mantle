...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-190%2C424-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C676%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-243-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **190,424** lines in 1,187 files |
| 🧪 &nbsp;Test suite | **3,676+** cases declared in 324 files |
| ⚖️ &nbsp;Test weight | 52,976 lines — 1 for every 3.6 of source |
...
**Velocity** — v0.232.86, 2,798 commits and 243 releases since 2026-05-14 (109 days, ~25.7 commits/day).
