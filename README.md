...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-184%2C035-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C548%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-223-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **184,035** lines in 1,151 files |
| 🧪 &nbsp;Test suite | **3,548+** cases declared in 312 files |
| ⚖️ &nbsp;Test weight | 50,726 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,331 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 122 engineering docs, 77 user-guide pages, 224 changelog entries (56,004 lines) |
...
**Velocity** — v0.232.57, 2,736 commits and 223 releases since 2026-05-14 (102 days, ~26.8 commits/day).
