...
![tests](https://img.shields.io/badge/tests-3%2C356%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| 🧪 &nbsp;Test suite | **3,356+** cases declared in 289 files |
| ⚖️ &nbsp;Test weight | 48,101 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,162 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 115 engineering docs, 77 user-guide pages, 217 changelog entries (48,263 lines) |
...
**Velocity** — v0.230.49, 2,543 commits and 184 releases since 2026-05-14 (92 days, ~27.6 commits/day).
