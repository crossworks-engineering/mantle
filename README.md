...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-173%2C848-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C454%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-202-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **173,848** lines in 1,122 files |
| 🧪 &nbsp;Test suite | **3,454+** cases declared in 301 files |
| ⚖️ &nbsp;Test weight | 49,543 lines — 1 for every 3.5 of source |
...
**Velocity** — v0.232.13, 2,635 commits and 202 releases since 2026-05-14 (99 days, ~26.6 commits/day).
