...
![tests](https://img.shields.io/badge/tests-3%2C980%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| 🧪 &nbsp;Test suite | **3,980+** cases declared in 362 files |
| ⚖️ &nbsp;Test weight | 57,916 lines — 1 for every 3.3 of source |
| 🗂️ &nbsp;Tracked files | 2,495 |
...
**Velocity** — v0.232.155, 2,945 commits and 273 releases since 2026-05-14 (112 days, ~26.3 commits/day).

```
commits/week, last 16 weeks   ▄▇▆▄▂▃█▄▃▆▆▅▃▄▄▅   peak 364
```
