...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-203%2C236-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C135%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-316-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **203,236** lines in 1,325 files |
| 🧪 &nbsp;Test suite | **5,135+** cases declared in 449 files |
| ⚖️ &nbsp;Test weight | 79,401 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,655 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,540 lines) |
...
**Velocity** — v0.232.230, 3,128 commits and 316 releases since 2026-05-14 (133 days, ~23.5 commits/day).
