...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-170%2C228-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **170,228** lines in 1,105 files |
| 🧪 &nbsp;Test suite | **3,349+** cases declared in 291 files |
| ⚖️ &nbsp;Test weight | 48,109 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,232 |
| 🐘 &nbsp;SQL migrations | 150, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (53,965 lines) |
...
**Velocity** — v0.230.66, 2,584 commits and 189 releases since 2026-05-14 (95 days, ~27.2 commits/day).
