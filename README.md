...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-170%2C109-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C348%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **170,109** lines in 1,104 files |
| 🧪 &nbsp;Test suite | **3,348+** cases declared in 291 files |
| ⚖️ &nbsp;Test weight | 48,100 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,231 |
| 🐘 &nbsp;SQL migrations | 150, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (53,962 lines) |
...
**Velocity** — v0.230.65, 2,582 commits and 189 releases since 2026-05-14 (95 days, ~27.2 commits/day).
