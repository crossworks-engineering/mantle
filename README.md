...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-169%2C071-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **169,071** lines in 1,092 files |
| 🧪 &nbsp;Test suite | **3,356+** cases declared in 289 files |
| ⚖️ &nbsp;Test weight | 48,101 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,198 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (53,784 lines) |
...
**Velocity** — v0.230.50, 2,545 commits and 184 releases since 2026-05-14 (92 days, ~27.7 commits/day).
