...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C827-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C764%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-262-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,827** lines in 1,183 files |
| 🧪 &nbsp;Test suite | **3,764+** cases declared in 331 files |
| ⚖️ &nbsp;Test weight | 54,265 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,394 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,333 lines) |
...
**Velocity** — v0.232.114, 2,856 commits and 262 releases since 2026-05-14 (111 days, ~25.7 commits/day).
