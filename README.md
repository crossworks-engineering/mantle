...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C844-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C915%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,844** lines in 1,244 files |
| 🧪 &nbsp;Test suite | **3,915+** cases declared in 356 files |
| ⚖️ &nbsp;Test weight | 56,912 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,488 |
...
**Velocity** — v0.232.151, 2,934 commits and 271 releases since 2026-05-14 (112 days, ~26.2 commits/day).
