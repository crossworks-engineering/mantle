...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-204%2C117-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C181%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-318-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **204,117** lines in 1,326 files |
| 🧪 &nbsp;Test suite | **5,181+** cases declared in 454 files |
| ⚖️ &nbsp;Test weight | 80,279 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,661 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,666 lines) |
...
**Velocity** — v0.232.233, 3,141 commits and 318 releases since 2026-05-14 (133 days, ~23.6 commits/day).
