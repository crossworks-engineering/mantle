...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-260%2C240-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **260,240** lines in 1,616 files |
| 🧪 &nbsp;Test suite | **3,601+** cases declared in 320 files |
| ⚖️ &nbsp;Test weight | 50,766 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,795 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (47,855 lines) |
...
**Velocity** — v0.230.32, 2,509 commits and 181 releases since 2026-05-14 (92 days, ~27.3 commits/day).
