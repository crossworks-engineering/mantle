...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C424-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C838%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,424** lines in 1,249 files |
| 🧪 &nbsp;Test suite | **4,838+** cases declared in 417 files |
| ⚖️ &nbsp;Test weight | 73,843 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,556 |
...
**Velocity** — v0.232.166, 2,981 commits and 275 releases since 2026-05-14 (112 days, ~26.6 commits/day).
