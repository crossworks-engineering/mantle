...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-211%2C740-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C393%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-343-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **211,740** lines in 1,374 files |
| 🧪 &nbsp;Test suite | **5,393+** cases declared in 483 files |
| ⚖️ &nbsp;Test weight | 84,170 lines — 1 for every 2.5 of source |
...
**Velocity** — v0.232.269, 3,255 commits and 343 releases since 2026-05-14 (136 days, ~23.9 commits/day).

```
commits/week, last 20 weeks   ▁▇▇▇▂▁▇▆▃▅▅█▆▄▄▂▆▁▂▅   peak 327
```
