...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-175%2C073-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C471%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **175,073** lines in 1,125 files |
| 🧪 &nbsp;Test suite | **3,471+** cases declared in 303 files |
| ⚖️ &nbsp;Test weight | 49,767 lines — 1 for every 3.5 of source |
...
**Velocity** — v0.232.26, 2,662 commits and 212 releases since 2026-05-14 (100 days, ~26.6 commits/day).

```
commits/week, last 15 weeks   ▁▅▇▆▃▁▄█▃▄▅█▅▄▃   peak 361
```
