...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C348-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C792%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,348** lines in 1,187 files |
| 🧪 &nbsp;Test suite | **3,792+** cases declared in 335 files |
| ⚖️ &nbsp;Test weight | 54,776 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,402 |
...
**Velocity** — v0.232.117, 2,862 commits and 263 releases since 2026-05-14 (111 days, ~25.8 commits/day).
