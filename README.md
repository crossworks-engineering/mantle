...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C958-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C856%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,958** lines in 1,227 files |
| 🧪 &nbsp;Test suite | **3,856+** cases declared in 345 files |
| ⚖️ &nbsp;Test weight | 55,686 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,459 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (57,485 lines) |
...
**Velocity** — v0.232.135, 2,902 commits and 269 releases since 2026-05-14 (112 days, ~25.9 commits/day).
