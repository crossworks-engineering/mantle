...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-211%2C710-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C392%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-167-336791?logo=postgresql&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-342-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **211,710** lines in 1,374 files |
| 🧪 &nbsp;Test suite | **5,392+** cases declared in 483 files |
| ⚖️ &nbsp;Test weight | 84,157 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,753 |
| 🐘 &nbsp;SQL migrations | 167, replayed in order on every boot |
| 📚 &nbsp;Docs | 96 engineering docs, 79 user-guide pages, 224 changelog entries (59,289 lines) |
...
**Velocity** — v0.232.268, 3,252 commits and 342 releases since 2026-05-14 (136 days, ~23.9 commits/day).

```
commits/week, last 20 weeks   ▁▇▇▇▂▁▇▆▃▅▅█▆▄▄▂▆▁▂▅   peak 332
```
