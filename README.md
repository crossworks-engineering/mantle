...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C614-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,614** lines in 1,215 files |
| 🧪 &nbsp;Test suite | **3,850+** cases declared in 344 files |
| ⚖️ &nbsp;Test weight | 55,569 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,450 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (57,483 lines) |
...
**Velocity** — v0.232.130, 2,890 commits and 268 releases since 2026-05-14 (112 days, ~25.8 commits/day).
