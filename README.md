...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C823-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C857%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,823** lines in 1,268 files |
| 🧪 &nbsp;Test suite | **4,857+** cases declared in 421 files |
| ⚖️ &nbsp;Test weight | 74,388 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,579 |
...
**Velocity** — v0.232.168, 2,988 commits and 275 releases since 2026-05-14 (112 days, ~26.7 commits/day).
