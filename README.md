...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-257%2C906-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **257,906** lines in 1,549 files |
| 🧪 &nbsp;Test suite | **3,556+** cases declared in 317 files |
| ⚖️ &nbsp;Test weight | 50,286 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,768 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 216 changelog entries (47,435 lines) |
...
**Velocity** — v0.230.5, 2,445 commits and 177 releases since 2026-05-14 (87 days, ~28.1 commits/day).
