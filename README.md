...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-195%2C454-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C901%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **195,454** lines in 1,293 files |
| 🧪 &nbsp;Test suite | **4,901+** cases declared in 423 files |
| ⚖️ &nbsp;Test weight | 74,921 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,606 |
...
**Velocity** — v0.232.170, 2,992 commits and 275 releases since 2026-05-14 (112 days, ~26.7 commits/day).
