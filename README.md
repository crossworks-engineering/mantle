...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-173%2C147-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C411%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **173,147** lines in 1,118 files |
| 🧪 &nbsp;Test suite | **3,411+** cases declared in 294 files |
| ⚖️ &nbsp;Test weight | 48,968 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,262 |
...
**Velocity** — v0.232.7, 2,621 commits and 196 releases since 2026-05-14 (98 days, ~26.7 commits/day).
