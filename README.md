...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-210%2C485-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C363%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-165-336791?logo=postgresql&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-340-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **210,485** lines in 1,362 files |
| 🧪 &nbsp;Test suite | **5,363+** cases declared in 481 files |
| ⚖️ &nbsp;Test weight | 83,559 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,737 |
| 🐘 &nbsp;SQL migrations | 165, replayed in order on every boot |
| 📚 &nbsp;Docs | 96 engineering docs, 79 user-guide pages, 224 changelog entries (59,213 lines) |
...
**Velocity** — v0.232.266, 3,245 commits and 340 releases since 2026-05-14 (136 days, ~23.9 commits/day).

```
commits/week, last 20 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▆▄▄▂▆▁▂▅   peak 333
```
