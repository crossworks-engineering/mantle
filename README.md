...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-189%2C630-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C655%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-239-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **189,630** lines in 1,184 files |
| 🧪 &nbsp;Test suite | **3,655+** cases declared in 322 files |
| ⚖️ &nbsp;Test weight | 52,715 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,382 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,139 lines) |
...
**Velocity** — v0.232.81, 2,786 commits and 239 releases since 2026-05-14 (109 days, ~25.6 commits/day).

```
commits/week, last 16 weeks   ▁█▇█▂▁█▆▃▆▇▇▆▄▄▂   peak 308
```
