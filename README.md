...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-196%2C235-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C960%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **196,235** lines in 1,297 files |
| 🧪 &nbsp;Test suite | **4,960+** cases declared in 433 files |
| ⚖️ &nbsp;Test weight | 76,077 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,620 |
...
**Velocity** — v0.232.181, 3,021 commits and 275 releases since 2026-05-14 (119 days, ~25.4 commits/day).

```
commits/week, last 17 weeks   ▃▇▆▄▂▂█▄▃▅▇▅▃▄▄▃▄   peak 360
```
