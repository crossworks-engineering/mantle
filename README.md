...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C415-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C888%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,415** lines in 1,234 files |
| 🧪 &nbsp;Test suite | **3,888+** cases declared in 350 files |
| ⚖️ &nbsp;Test weight | 56,267 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,472 |
...
**Velocity** — v0.232.145, 2,922 commits and 271 releases since 2026-05-14 (112 days, ~26.1 commits/day).

```
commits/week, last 16 weeks   ▄▇▆▄▂▂█▄▃▆▆▅▃▄▄▄   peak 357
```
