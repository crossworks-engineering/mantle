...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-173%2C771-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C451%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-150-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-200-6b4fbb)
![docs](https://img.shields.io/badge/docs-117%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-200-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **173,771** lines in 1,122 files |
| 🧪 &nbsp;Test suite | **3,451+** cases declared in 301 files |
| ⚖️ &nbsp;Test weight | 49,479 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,273 |
| 🐘 &nbsp;SQL migrations | 150, replayed in order on every boot |
| 📚 &nbsp;Docs | 117 engineering docs, 77 user-guide pages, 217 changelog entries (54,836 lines) |
...
| 🧰 &nbsp;Built-in tools | 200, granted in 53 tool groups |
...
**Velocity** — v0.232.11, 2,631 commits and 200 releases since 2026-05-14 (99 days, ~26.6 commits/day).

```
commits/week, last 15 weeks   ▁▄▇▆▄▂▃█▄▃▅▇▅▄▄   peak 371
```
