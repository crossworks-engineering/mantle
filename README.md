...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-257%2C716-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **257,716** lines in 1,546 files |
| 🧪 &nbsp;Test suite | **3,548+** cases declared in 316 files |
| ⚖️ &nbsp;Test weight | 50,209 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,764 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 216 changelog entries (47,392 lines) |
...
**Velocity** — v0.230.3, 2,441 commits and 177 releases since 2026-05-14 (86 days, ~28.4 commits/day).
