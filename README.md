...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C148-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C884%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,148** lines in 1,223 files |
| 🧪 &nbsp;Test suite | **3,884+** cases declared in 348 files |
| ⚖️ &nbsp;Test weight | 56,142 lines — 1 for every 3.4 of source |
...
**Velocity** — v0.232.141, 2,914 commits and 270 releases since 2026-05-14 (112 days, ~26.0 commits/day).
