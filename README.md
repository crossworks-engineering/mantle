...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C152-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C783%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,152** lines in 1,246 files |
| 🧪 &nbsp;Test suite | **4,783+** cases declared in 411 files |
| ⚖️ &nbsp;Test weight | 72,584 lines — 1 for every 2.7 of source |
| 🗂️ &nbsp;Tracked files | 2,546 |
...
**Velocity** — v0.232.162, 2,973 commits and 273 releases since 2026-05-14 (112 days, ~26.5 commits/day).
