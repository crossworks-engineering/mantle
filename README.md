...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-174%2C627-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C460%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-211-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **174,627** lines in 1,125 files |
| 🧪 &nbsp;Test suite | **3,460+** cases declared in 302 files |
| ⚖️ &nbsp;Test weight | 49,611 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,278 |
| 🐘 &nbsp;SQL migrations | 151, replayed in order on every boot |
| 📚 &nbsp;Docs | 117 engineering docs, 77 user-guide pages, 217 changelog entries (54,868 lines) |
...
| 🧠 &nbsp;Skills | 19 composable behaviours |
...
**Velocity** — v0.232.23, 2,656 commits and 211 releases since 2026-05-14 (100 days, ~26.6 commits/day).

```
commits/week, last 15 weeks   ▁▅▇▆▃▁▃█▃▄▅█▄▄▃   peak 370
```
