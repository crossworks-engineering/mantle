...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-259%2C463-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **259,463** lines in 1,557 files |
| 🧪 &nbsp;Test suite | **3,601+** cases declared in 320 files |
| ⚖️ &nbsp;Test weight | 50,765 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,723 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (47,620 lines) |
...
**Velocity** — v0.230.20, 2,476 commits and 178 releases since 2026-05-14 (91 days, ~27.2 commits/day).
