...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-260%2C361-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **260,361** lines in 1,647 files |
| 🧪 &nbsp;Test suite | **3,601+** cases declared in 320 files |
| ⚖️ &nbsp;Test weight | 50,769 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,828 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (47,873 lines) |
...
**Velocity** — v0.230.36, 2,517 commits and 181 releases since 2026-05-14 (92 days, ~27.4 commits/day).

```
commits/week, last 14 weeks   ▁▄▇▆▄▁▃█▄▃▅▆▅▄   peak 380
```
