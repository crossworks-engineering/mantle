...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C381-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C832%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,381** lines in 1,249 files |
| 🧪 &nbsp;Test suite | **4,832+** cases declared in 416 files |
| ⚖️ &nbsp;Test weight | 73,636 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,554 |
...
**Velocity** — v0.232.164, 2,977 commits and 274 releases since 2026-05-14 (112 days, ~26.6 commits/day).
