...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C944-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C878%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,944** lines in 1,213 files |
| 🧪 &nbsp;Test suite | **3,878+** cases declared in 348 files |
| ⚖️ &nbsp;Test weight | 56,045 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,449 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (57,520 lines) |
...
**Velocity** — v0.232.138, 2,908 commits and 269 releases since 2026-05-14 (112 days, ~26.0 commits/day).
