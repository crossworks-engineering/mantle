...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-257%2C649-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C545%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **257,649** lines in 1,545 files |
| 🧪 &nbsp;Test suite | **3,545+** cases declared in 315 files |
| ⚖️ &nbsp;Test weight | 50,178 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,762 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 216 changelog entries (47,361 lines) |
...
**Velocity** — v0.230.2, 2,439 commits and 177 releases since 2026-05-14 (86 days, ~28.4 commits/day).

```
commits/week, last 13 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅   peak 343
```
