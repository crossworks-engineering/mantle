...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C979-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C744%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,979** lines in 1,245 files |
| 🧪 &nbsp;Test suite | **4,744+** cases declared in 407 files |
| ⚖️ &nbsp;Test weight | 71,700 lines — 1 for every 2.7 of source |
| 🗂️ &nbsp;Tracked files | 2,540 |
...
**Velocity** — v0.232.159, 2,965 commits and 273 releases since 2026-05-14 (112 days, ~26.5 commits/day).

```
commits/week, last 16 weeks   ▄▇▆▄▂▃█▄▃▅▆▅▃▄▄▅   peak 368
```
