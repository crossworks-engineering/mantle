...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C600-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C843%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,600** lines in 1,259 files |
| 🧪 &nbsp;Test suite | **4,843+** cases declared in 419 files |
| ⚖️ &nbsp;Test weight | 73,962 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,568 |
...
**Velocity** — v0.232.167, 2,984 commits and 275 releases since 2026-05-14 (112 days, ~26.6 commits/day).

```
commits/week, last 16 weeks   ▄▇▆▄▂▃█▄▃▅▆▅▃▄▄▅   peak 371
```
