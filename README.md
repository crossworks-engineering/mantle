...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-173%2C390-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C420%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-197-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **173,390** lines in 1,119 files |
| 🧪 &nbsp;Test suite | **3,420+** cases declared in 296 files |
| ⚖️ &nbsp;Test weight | 49,096 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,265 |
...
**Velocity** — v0.232.8, 2,625 commits and 197 releases since 2026-05-14 (98 days, ~26.8 commits/day).
