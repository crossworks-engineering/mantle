...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C128-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C772%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,128** lines in 1,186 files |
| 🧪 &nbsp;Test suite | **3,772+** cases declared in 332 files |
| ⚖️ &nbsp;Test weight | 54,351 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,398 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,348 lines) |
...
**Velocity** — v0.232.115, 2,858 commits and 263 releases since 2026-05-14 (111 days, ~25.7 commits/day).
