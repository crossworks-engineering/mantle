...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-191%2C697-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C698%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **191,697** lines in 1,188 files |
| 🧪 &nbsp;Test suite | **3,698+** cases declared in 325 files |
| ⚖️ &nbsp;Test weight | 53,394 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,393 |
...
**Velocity** — v0.232.99, 2,824 commits and 253 releases since 2026-05-14 (110 days, ~25.7 commits/day).
