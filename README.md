...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-195%2C035-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C897%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **195,035** lines in 1,270 files |
| 🧪 &nbsp;Test suite | **4,897+** cases declared in 422 files |
| ⚖️ &nbsp;Test weight | 74,753 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,582 |
...
**Velocity** — v0.232.169, 2,990 commits and 275 releases since 2026-05-14 (112 days, ~26.7 commits/day).
