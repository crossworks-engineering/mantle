...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-173%2C728-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C444%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-199-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **173,728** lines in 1,122 files |
| 🧪 &nbsp;Test suite | **3,444+** cases declared in 300 files |
| ⚖️ &nbsp;Test weight | 49,385 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,272 |
...
**Velocity** — v0.232.10, 2,629 commits and 199 releases since 2026-05-14 (99 days, ~26.6 commits/day).
