...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-206%2C949-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C257%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-329-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **206,949** lines in 1,339 files |
| 🧪 &nbsp;Test suite | **5,257+** cases declared in 460 files |
| ⚖️ &nbsp;Test weight | 81,433 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,684 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,933 lines) |
...
**Velocity** — v0.232.254, 3,198 commits and 329 releases since 2026-05-14 (134 days, ~23.9 commits/day).

```
commits/week, last 20 weeks   ▁▄▇▆▃▁▃█▃▄▅▇▅▄▃▃▅▁▂▃   peak 376
```
