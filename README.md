...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-195%2C872-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C946%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **195,872** lines in 1,294 files |
| 🧪 &nbsp;Test suite | **4,946+** cases declared in 431 files |
| ⚖️ &nbsp;Test weight | 75,943 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,615 |
| 🐘 &nbsp;SQL migrations | 156, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (57,686 lines) |
...
**Velocity** — v0.232.179, 3,017 commits and 275 releases since 2026-05-14 (117 days, ~25.8 commits/day).

```
commits/week, last 17 weeks   ▂▇▆▆▂▂█▄▃▅▇▆▅▄▄▂▅   peak 343
```
