...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-258%2C555-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C589%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **258,555** lines in 1,552 files |
| 🧪 &nbsp;Test suite | **3,589+** cases declared in 320 files |
| ⚖️ &nbsp;Test weight | 50,601 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,775 |
...
**Velocity** — v0.230.13, 2,462 commits and 178 releases since 2026-05-14 (91 days, ~27.1 commits/day).

```
commits/week, last 13 weeks   ▄▇▆▄▂▃█▄▃▅▆▅▃   peak 371
```
