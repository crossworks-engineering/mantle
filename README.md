...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-181%2C720-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C517%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **181,720** lines in 1,142 files |
| 🧪 &nbsp;Test suite | **3,517+** cases declared in 309 files |
| ⚖️ &nbsp;Test weight | 50,331 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,315 |
...
**Velocity** — v0.232.47, 2,708 commits and 217 releases since 2026-05-14 (101 days, ~26.8 commits/day).
