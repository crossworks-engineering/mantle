...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-213%2C266-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C424%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-169-336791?logo=postgresql&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-348-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **213,266** lines in 1,386 files |
| 🧪 &nbsp;Test suite | **5,424+** cases declared in 488 files |
| ⚖️ &nbsp;Test weight | 84,985 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,772 |
| 🐘 &nbsp;SQL migrations | 169, replayed in order on every boot |
| 📚 &nbsp;Docs | 96 engineering docs, 79 user-guide pages, 224 changelog entries (59,367 lines) |
...
| 🧰 &nbsp;Built-in tools | 250, granted in 59 tool groups |
...
**Velocity** — v0.232.274, 3,273 commits and 348 releases since 2026-05-14 (136 days, ~24.1 commits/day).

```
commits/week, last 20 weeks   ▁▇▇▇▂▁▇▆▃▆▆█▆▄▄▂▆▁▂▅   peak 310
```
