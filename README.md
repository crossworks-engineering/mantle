...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-174%2C958-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C468%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **174,958** lines in 1,126 files |
| 🧪 &nbsp;Test suite | **3,468+** cases declared in 303 files |
| ⚖️ &nbsp;Test weight | 49,732 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,281 |
| 🐘 &nbsp;SQL migrations | 151, replayed in order on every boot |
| 📚 &nbsp;Docs | 117 engineering docs, 77 user-guide pages, 218 changelog entries (54,980 lines) |
...
**Velocity** — v0.232.24, 2,658 commits and 212 releases since 2026-05-14 (100 days, ~26.6 commits/day).
