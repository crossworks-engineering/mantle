...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-175%2C768-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C484%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **175,768** lines in 1,127 files |
| 🧪 &nbsp;Test suite | **3,484+** cases declared in 305 files |
| ⚖️ &nbsp;Test weight | 49,987 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,286 |
| 🐘 &nbsp;SQL migrations | 151, replayed in order on every boot |
| 📚 &nbsp;Docs | 117 engineering docs, 77 user-guide pages, 221 changelog entries (55,303 lines) |
...
**Velocity** — v0.232.31, 2,672 commits and 212 releases since 2026-05-14 (100 days, ~26.7 commits/day).
