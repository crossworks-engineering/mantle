...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C754-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C801%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,754** lines in 1,191 files |
| 🧪 &nbsp;Test suite | **3,801+** cases declared in 338 files |
| ⚖️ &nbsp;Test weight | 54,909 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,417 |
...
**Velocity** — v0.232.121, 2,870 commits and 263 releases since 2026-05-14 (111 days, ~25.9 commits/day).
