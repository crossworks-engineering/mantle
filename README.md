...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-170%2C573-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C354%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-191-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **170,573** lines in 1,108 files |
| 🧪 &nbsp;Test suite | **3,354+** cases declared in 291 files |
| ⚖️ &nbsp;Test weight | 48,147 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,235 |
| 🐘 &nbsp;SQL migrations | 150, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (53,631 lines) |
...
**Velocity** — v0.230.69, 2,595 commits and 191 releases since 2026-05-14 (98 days, ~26.5 commits/day).
