...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C303-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C886%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,303** lines in 1,229 files |
| 🧪 &nbsp;Test suite | **3,886+** cases declared in 349 files |
| ⚖️ &nbsp;Test weight | 56,209 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,466 |
...
**Velocity** — v0.232.144, 2,920 commits and 271 releases since 2026-05-14 (112 days, ~26.1 commits/day).
