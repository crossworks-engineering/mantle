...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-185%2C205-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C570%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-233-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **185,205** lines in 1,163 files |
| 🧪 &nbsp;Test suite | **3,570+** cases declared in 314 files |
| ⚖️ &nbsp;Test weight | 50,952 lines — 1 for every 3.6 of source |
...
**Velocity** — v0.232.67, 2,757 commits and 233 releases since 2026-05-14 (104 days, ~26.5 commits/day).
