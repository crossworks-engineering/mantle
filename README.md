...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-184%2C319-3178c6?logo=typescript&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-224-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **184,319** lines in 1,156 files |
| 🧪 &nbsp;Test suite | **3,551+** cases declared in 312 files |
| ⚖️ &nbsp;Test weight | 50,757 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,336 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 122 engineering docs, 77 user-guide pages, 224 changelog entries (56,033 lines) |
...
**Velocity** — v0.232.58, 2,739 commits and 224 releases since 2026-05-14 (102 days, ~26.9 commits/day).
