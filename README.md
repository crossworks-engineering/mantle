...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C034-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C734%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,034** lines in 1,189 files |
| 🧪 &nbsp;Test suite | **3,734+** cases declared in 327 files |
| ⚖️ &nbsp;Test weight | 53,876 lines — 1 for every 3.6 of source |
...
**Velocity** — v0.232.104, 2,834 commits and 256 releases since 2026-05-14 (110 days, ~25.8 commits/day).
