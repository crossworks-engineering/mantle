...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-189%2C433-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C650%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **189,433** lines in 1,182 files |
| 🧪 &nbsp;Test suite | **3,650+** cases declared in 322 files |
| ⚖️ &nbsp;Test weight | 52,653 lines — 1 for every 3.6 of source |
...
**Velocity** — v0.232.78, 2,780 commits and 238 releases since 2026-05-14 (108 days, ~25.7 commits/day).

```
commits/week, last 16 weeks   ▁▇▇█▂▁█▆▃▆▆█▆▄▄▂   peak 304
```
