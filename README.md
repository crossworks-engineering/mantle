...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C129-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,129** lines in 1,190 files |
| 🧪 &nbsp;Test suite | **3,764+** cases declared in 331 files |
| ⚖️ &nbsp;Test weight | 54,265 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,401 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,334 lines) |
...
**Velocity** — v0.232.113, 2,854 commits and 262 releases since 2026-05-14 (111 days, ~25.7 commits/day).
