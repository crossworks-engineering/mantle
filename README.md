...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-177%2C165-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C504%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-151-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-205-6b4fbb)
![docs](https://img.shields.io/badge/docs-118%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-212-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **177,165** lines in 1,130 files |
| 🧪 &nbsp;Test suite | **3,504+** cases declared in 306 files |
| ⚖️ &nbsp;Test weight | 50,203 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,294 |
| 🐘 &nbsp;SQL migrations | 151, replayed in order on every boot |
| 📚 &nbsp;Docs | 118 engineering docs, 77 user-guide pages, 222 changelog entries (55,437 lines) |
...
| 🧰 &nbsp;Built-in tools | 205, granted in 54 tool groups |
...
**Velocity** — v0.232.33, 2,680 commits and 212 releases since 2026-05-14 (100 days, ~26.8 commits/day).

```
commits/week, last 15 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅▄▃   peak 346
```
