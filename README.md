...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-196%2C943-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C982%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-285-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **196,943** lines in 1,297 files |
| 🧪 &nbsp;Test suite | **4,982+** cases declared in 436 files |
| ⚖️ &nbsp;Test weight | 76,727 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,623 |
...
**Velocity** — v0.232.191, 3,044 commits and 285 releases since 2026-05-14 (125 days, ~24.4 commits/day).
