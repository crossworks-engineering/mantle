...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-181%2C778-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C519%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-153-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-218-6b4fbb)
![docs](https://img.shields.io/badge/docs-120%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-217-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **181,778** lines in 1,142 files |
| 🧪 &nbsp;Test suite | **3,519+** cases declared in 310 files |
| ⚖️ &nbsp;Test weight | 50,358 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,316 |
| 🐘 &nbsp;SQL migrations | 153, replayed in order on every boot |
| 📚 &nbsp;Docs | 120 engineering docs, 77 user-guide pages, 224 changelog entries (55,703 lines) |
...
| | |
| --- | --- |
| 🤖 &nbsp;Agents | 14 (your assistant + its specialists) |
| 🧠 &nbsp;Skills | 20 composable behaviours |
| 🧰 &nbsp;Built-in tools | 218, granted in 56 tool groups |
...
**Velocity** — v0.232.48, 2,710 commits and 217 releases since 2026-05-14 (101 days, ~26.8 commits/day).

```
commits/week, last 15 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▆▄▄   peak 333
```
