...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-202%2C264-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C123%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **202,264** lines in 1,321 files |
| 🧪 &nbsp;Test suite | **5,123+** cases declared in 447 files |
| ⚖️ &nbsp;Test weight | 79,155 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,649 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,482 lines) |
...
**Velocity** — v0.232.229, 3,124 commits and 316 releases since 2026-05-14 (133 days, ~23.5 commits/day).
