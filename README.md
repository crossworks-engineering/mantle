...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-211%2C705-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C391%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-341-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **211,705** lines in 1,374 files |
| 🧪 &nbsp;Test suite | **5,391+** cases declared in 483 files |
| ⚖️ &nbsp;Test weight | 84,148 lines — 1 for every 2.5 of source |
...
**Velocity** — v0.232.267, 3,250 commits and 341 releases since 2026-05-14 (136 days, ~23.9 commits/day).
