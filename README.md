...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-186%2C488-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C596%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-155-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-224-6b4fbb)
![docs](https://img.shields.io/badge/docs-123%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-236-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **186,488** lines in 1,170 files |
| 🧪 &nbsp;Test suite | **3,596+** cases declared in 316 files |
| ⚖️ &nbsp;Test weight | 51,344 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,358 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 123 engineering docs, 78 user-guide pages, 224 changelog entries (56,374 lines) |
...
| 🧰 &nbsp;Built-in tools | 224, granted in 57 tool groups |
...
**Velocity** — v0.232.70, 2,764 commits and 236 releases since 2026-05-14 (107 days, ~25.8 commits/day).

```
commits/week, last 16 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅▄▃▃   peak 344
```
