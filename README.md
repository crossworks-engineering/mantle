...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C057-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C738%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,057** lines in 1,189 files |
| 🧪 &nbsp;Test suite | **3,738+** cases declared in 327 files |
| ⚖️ &nbsp;Test weight | 53,945 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,396 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,232 lines) |
...
**Velocity** — v0.232.108, 2,843 commits and 259 releases since 2026-05-14 (111 days, ~25.6 commits/day).
