...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-198%2C599-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C019%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **198,599** lines in 1,310 files |
| 🧪 &nbsp;Test suite | **5,019+** cases declared in 439 files |
| ⚖️ &nbsp;Test weight | 77,309 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,630 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,240 lines) |
...
**Velocity** — v0.232.209, 3,081 commits and 301 releases since 2026-05-14 (131 days, ~23.5 commits/day).

```
commits/week, last 19 weeks   ▂▇▇▆▂▂█▄▃▅▇▅▄▄▄▃▅▁▂   peak 349
```
