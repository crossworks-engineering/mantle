...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C756-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C898%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,756** lines in 1,243 files |
| 🧪 &nbsp;Test suite | **3,898+** cases declared in 354 files |
| ⚖️ &nbsp;Test weight | 56,535 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,485 |
...
**Velocity** — v0.232.148, 2,928 commits and 271 releases since 2026-05-14 (112 days, ~26.1 commits/day).
