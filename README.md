...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-178%2C404-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C511%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **178,404** lines in 1,132 files |
| 🧪 &nbsp;Test suite | **3,511+** cases declared in 307 files |
| ⚖️ &nbsp;Test weight | 50,246 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,301 |
...
**Velocity** — v0.232.40, 2,694 commits and 216 releases since 2026-05-14 (100 days, ~26.9 commits/day).
