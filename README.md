...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-182%2C229-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C527%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-221-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **182,229** lines in 1,146 files |
| 🧪 &nbsp;Test suite | **3,527+** cases declared in 311 files |
| ⚖️ &nbsp;Test weight | 50,482 lines — 1 for every 3.6 of source |
...
**Velocity** — v0.232.55, 2,725 commits and 221 releases since 2026-05-14 (102 days, ~26.7 commits/day).
