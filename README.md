...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-210%2C444-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C360%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-338-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **210,444** lines in 1,362 files |
| 🧪 &nbsp;Test suite | **5,360+** cases declared in 481 files |
| ⚖️ &nbsp;Test weight | 83,537 lines — 1 for every 2.5 of source |
...
**Velocity** — v0.232.264, 3,241 commits and 338 releases since 2026-05-14 (136 days, ~23.8 commits/day).

```
commits/week, last 20 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅▄▄▃▆▁▂▄   peak 338
```
