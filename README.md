...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-251%2C113-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C476%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-144-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-195-6b4fbb)
![docs](https://img.shields.io/badge/docs-110%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-172-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **251,113** lines in 1,504 files |
| 🧪 &nbsp;Test suite | **3,476+** cases declared in 308 files |
| ⚖️ &nbsp;Test weight | 49,465 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,691 |
| 🐘 &nbsp;SQL migrations | 144, replayed in order on every boot |
| 📚 &nbsp;Docs | 110 engineering docs, 76 user-guide pages, 215 changelog entries (45,914 lines) |
...
| | |
| --- | --- |
| 🤖 &nbsp;Agents | 12 (your assistant + its specialists) |
| 🧠 &nbsp;Skills | 17 composable behaviours |
| 🧰 &nbsp;Built-in tools | 195, granted in 51 tool groups |
...
**Velocity** — v0.224.30, 2,381 commits and 172 releases since 2026-05-14 (85 days, ~28.0 commits/day).

```
commits/week, last 13 weeks   ▁▄▇▆▄▁▃█▄▃▅▆▅   peak 380
```
