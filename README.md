...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-178%2C045-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C505%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-152-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-209-6b4fbb)
![docs](https://img.shields.io/badge/docs-118%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-215-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **178,045** lines in 1,131 files |
| 🧪 &nbsp;Test suite | **3,505+** cases declared in 306 files |
| ⚖️ &nbsp;Test weight | 50,211 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,298 |
| 🐘 &nbsp;SQL migrations | 152, replayed in order on every boot |
| 📚 &nbsp;Docs | 118 engineering docs, 77 user-guide pages, 224 changelog entries (55,592 lines) |
...
| 🧰 &nbsp;Built-in tools | 209, granted in 54 tool groups |
...
**Velocity** — v0.232.39, 2,692 commits and 215 releases since 2026-05-14 (100 days, ~26.9 commits/day).

```
commits/week, last 15 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅▄▃   peak 343
```
