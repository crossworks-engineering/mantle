...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C227-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C741%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-259-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,227** lines in 1,189 files |
| 🧪 &nbsp;Test suite | **3,741+** cases declared in 327 files |
| ⚖️ &nbsp;Test weight | 53,995 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,396 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,263 lines) |
...
**Velocity** — v0.232.109, 2,845 commits and 259 releases since 2026-05-14 (111 days, ~25.6 commits/day).

```
commits/week, last 16 weeks   ▃▇▆▅▂▂█▄▃▅▇▆▄▄▄▃   peak 351
```
