...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-205%2C047-3178c6?logo=typescript&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-321-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **205,047** lines in 1,330 files |
| 🧪 &nbsp;Test suite | **5,203+** cases declared in 456 files |
| ⚖️ &nbsp;Test weight | 80,737 lines — 1 for every 2.5 of source |
...
**Velocity** — v0.232.236, 3,150 commits and 321 releases since 2026-05-14 (133 days, ~23.7 commits/day).
