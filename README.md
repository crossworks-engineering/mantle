...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-252%2C107-3178c6?logo=typescript&logoColor=white)
...
![docs](https://img.shields.io/badge/docs-111%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-175-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **252,107** lines in 1,512 files |
| 🧪 &nbsp;Test suite | **3,504+** cases declared in 310 files |
| ⚖️ &nbsp;Test weight | 49,709 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,712 |
| 🐘 &nbsp;SQL migrations | 144, replayed in order on every boot |
| 📚 &nbsp;Docs | 111 engineering docs, 76 user-guide pages, 216 changelog entries (46,103 lines) |
...
**Velocity** — v0.225.3, 2,396 commits and 175 releases since 2026-05-14 (86 days, ~27.9 commits/day).

```
commits/week, last 13 weeks   ▁▅▇▆▃▁▃█▃▄▅▇▄   peak 376
```
