...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C284-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C825%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-266-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,284** lines in 1,205 files |
| 🧪 &nbsp;Test suite | **3,825+** cases declared in 341 files |
| ⚖️ &nbsp;Test weight | 55,270 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,435 |
...
**Velocity** — v0.232.125, 2,880 commits and 266 releases since 2026-05-14 (112 days, ~25.7 commits/day).
