...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C557-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C890%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,557** lines in 1,239 files |
| 🧪 &nbsp;Test suite | **3,890+** cases declared in 351 files |
| ⚖️ &nbsp;Test weight | 56,333 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,478 |
...
**Velocity** — v0.232.146, 2,924 commits and 271 releases since 2026-05-14 (112 days, ~26.1 commits/day).
