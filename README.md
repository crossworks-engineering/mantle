...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-211%2C801-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C396%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-344-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **211,801** lines in 1,374 files |
| 🧪 &nbsp;Test suite | **5,396+** cases declared in 484 files |
| ⚖️ &nbsp;Test weight | 84,253 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,755 |
| 🐘 &nbsp;SQL migrations | 168, replayed in order on every boot |
| 📚 &nbsp;Docs | 96 engineering docs, 79 user-guide pages, 224 changelog entries (59,297 lines) |
...
**Velocity** — v0.232.270, 3,260 commits and 344 releases since 2026-05-14 (136 days, ~24.0 commits/day).

```
commits/week, last 20 weeks   ▁▇▇▇▂▁▇▆▃▅▅█▆▄▄▂▆▁▂▅   peak 319
```
