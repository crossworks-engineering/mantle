...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-200%2C464-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C067%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-310-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **200,464** lines in 1,315 files |
| 🧪 &nbsp;Test suite | **5,067+** cases declared in 442 files |
| ⚖️ &nbsp;Test weight | 78,287 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,638 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,295 lines) |
...
**Velocity** — v0.232.221, 3,106 commits and 310 releases since 2026-05-14 (132 days, ~23.5 commits/day).
