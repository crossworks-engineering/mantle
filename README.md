...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C874-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C869%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,874** lines in 1,213 files |
| 🧪 &nbsp;Test suite | **3,869+** cases declared in 347 files |
| ⚖️ &nbsp;Test weight | 55,853 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,448 |
...
**Velocity** — v0.232.137, 2,906 commits and 269 releases since 2026-05-14 (112 days, ~25.9 commits/day).
