...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-200%2C000-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C048%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-304-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **200,000** lines in 1,314 files |
| 🧪 &nbsp;Test suite | **5,048+** cases declared in 440 files |
| ⚖️ &nbsp;Test weight | 77,861 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,635 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,279 lines) |
...
**Velocity** — v0.232.214, 3,092 commits and 304 releases since 2026-05-14 (132 days, ~23.4 commits/day).

```
commits/week, last 19 weeks   ▂▇▆▅▂▂█▄▃▅▇▆▄▄▄▃▅▁▂   peak 352
```
