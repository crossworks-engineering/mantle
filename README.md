...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-202%2C168-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C118%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-315-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **202,168** lines in 1,321 files |
| 🧪 &nbsp;Test suite | **5,118+** cases declared in 447 files |
| ⚖️ &nbsp;Test weight | 79,055 lines — 1 for every 2.6 of source |
...
**Velocity** — v0.232.228, 3,121 commits and 315 releases since 2026-05-14 (133 days, ~23.5 commits/day).
