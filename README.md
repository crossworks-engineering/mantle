...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-205%2C023-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C203%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-319-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **205,023** lines in 1,330 files |
| 🧪 &nbsp;Test suite | **5,203+** cases declared in 456 files |
| ⚖️ &nbsp;Test weight | 80,726 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,667 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,746 lines) |
...
**Velocity** — v0.232.234, 3,143 commits and 319 releases since 2026-05-14 (133 days, ~23.6 commits/day).
