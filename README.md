...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-258%2C270-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C571%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-178-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **258,270** lines in 1,551 files |
| 🧪 &nbsp;Test suite | **3,571+** cases declared in 318 files |
| ⚖️ &nbsp;Test weight | 50,435 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,772 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (47,549 lines) |
...
**Velocity** — v0.230.10, 2,456 commits and 178 releases since 2026-05-14 (90 days, ~27.3 commits/day).

```
commits/week, last 13 weeks   ▃▇▆▄▂▂█▄▃▅▇▆▃   peak 360
```
