...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-185%2C172-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C564%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-232-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **185,172** lines in 1,163 files |
| 🧪 &nbsp;Test suite | **3,564+** cases declared in 313 files |
| ⚖️ &nbsp;Test weight | 50,894 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,346 |
...
**Velocity** — v0.232.66, 2,755 commits and 232 releases since 2026-05-14 (103 days, ~26.7 commits/day).
