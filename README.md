...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-191%2C094-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C685%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-249-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **191,094** lines in 1,187 files |
| 🧪 &nbsp;Test suite | **3,685+** cases declared in 324 files |
| ⚖️ &nbsp;Test weight | 53,163 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,387 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,149 lines) |
...
**Velocity** — v0.232.94, 2,814 commits and 249 releases since 2026-05-14 (110 days, ~25.6 commits/day).

```
commits/week, last 16 weeks   ▂▇▆▆▂▂█▄▃▅▆▆▅▄▄▂   peak 346
```
