...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-196%2C293-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C964%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **196,293** lines in 1,297 files |
| 🧪 &nbsp;Test suite | **4,964+** cases declared in 434 files |
| ⚖️ &nbsp;Test weight | 76,175 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,621 |
...
**Velocity** — v0.232.182, 3,023 commits and 276 releases since 2026-05-14 (119 days, ~25.4 commits/day).
