...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-205%2C398-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C224%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-325-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **205,398** lines in 1,331 files |
| 🧪 &nbsp;Test suite | **5,224+** cases declared in 457 files |
| ⚖️ &nbsp;Test weight | 81,068 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,671 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,806 lines) |
...
**Velocity** — v0.232.245, 3,171 commits and 325 releases since 2026-05-14 (134 days, ~23.7 commits/day).
