...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-198%2C923-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C027%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-302-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **198,923** lines in 1,311 files |
| 🧪 &nbsp;Test suite | **5,027+** cases declared in 439 files |
| ⚖️ &nbsp;Test weight | 77,418 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,631 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,278 lines) |
...
**Velocity** — v0.232.211, 3,086 commits and 302 releases since 2026-05-14 (131 days, ~23.6 commits/day).
