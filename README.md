...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-172%2C088-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C381%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-196-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **172,088** lines in 1,115 files |
| 🧪 &nbsp;Test suite | **3,381+** cases declared in 293 files |
| ⚖️ &nbsp;Test weight | 48,490 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,258 |
| 🐘 &nbsp;SQL migrations | 150, replayed in order on every boot |
| 📚 &nbsp;Docs | 117 engineering docs, 77 user-guide pages, 217 changelog entries (54,811 lines) |
...
**Velocity** — v0.232.4, 2,615 commits and 196 releases since 2026-05-14 (98 days, ~26.7 commits/day).
