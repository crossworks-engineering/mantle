...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C841-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C910%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,841** lines in 1,244 files |
| 🧪 &nbsp;Test suite | **3,910+** cases declared in 355 files |
| ⚖️ &nbsp;Test weight | 56,785 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,487 |
...
**Velocity** — v0.232.150, 2,932 commits and 271 releases since 2026-05-14 (112 days, ~26.2 commits/day).
