...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-195%2C628-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C925%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-156-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-244-6b4fbb)
![docs](https://img.shields.io/badge/docs-93%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-275-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **195,628** lines in 1,293 files |
| 🧪 &nbsp;Test suite | **4,925+** cases declared in 428 files |
| ⚖️ &nbsp;Test weight | 75,501 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,611 |
| 🐘 &nbsp;SQL migrations | 156, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (57,531 lines) |
...
| 🧰 &nbsp;Built-in tools | 244, granted in 57 tool groups |
...
**Velocity** — v0.232.174, 3,000 commits and 275 releases since 2026-05-14 (113 days, ~26.5 commits/day).

```
commits/week, last 17 weeks   ▁▄▇▆▄▂▃█▄▃▅▇▅▄▄▄▅   peak 371
```
