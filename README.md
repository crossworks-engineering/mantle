...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-201%2C831-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C111%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **201,831** lines in 1,320 files |
| 🧪 &nbsp;Test suite | **5,111+** cases declared in 446 files |
| ⚖️ &nbsp;Test weight | 78,916 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,647 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,445 lines) |
...
**Velocity** — v0.232.227, 3,119 commits and 315 releases since 2026-05-14 (133 days, ~23.5 commits/day).
