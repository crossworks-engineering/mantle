...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-209%2C233-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C336%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-162-336791?logo=postgresql&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-331-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **209,233** lines in 1,352 files |
| 🧪 &nbsp;Test suite | **5,336+** cases declared in 475 files |
| ⚖️ &nbsp;Test weight | 82,937 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,717 |
| 🐘 &nbsp;SQL migrations | 162, replayed in order on every boot |
| 📚 &nbsp;Docs | 95 engineering docs, 79 user-guide pages, 224 changelog entries (59,121 lines) |
...
**Velocity** — v0.232.257, 3,220 commits and 331 releases since 2026-05-14 (135 days, ~23.9 commits/day).

```
commits/week, last 20 weeks   ▁▅█▇▃▁▄█▃▅▅█▅▄▃▃▆▁▂▄   peak 340
```
