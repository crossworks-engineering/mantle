...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-195%2C907-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C948%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **195,907** lines in 1,294 files |
| 🧪 &nbsp;Test suite | **4,948+** cases declared in 431 files |
| ⚖️ &nbsp;Test weight | 75,961 lines — 1 for every 2.6 of source |
...
**Velocity** — v0.232.180, 3,019 commits and 275 releases since 2026-05-14 (117 days, ~25.8 commits/day).

```
commits/week, last 17 weeks   ▂▇▆▆▂▂█▄▃▅▆▆▅▄▄▂▅   peak 346
```
