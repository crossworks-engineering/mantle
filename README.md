...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-197%2C327-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C997%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-158-336791?logo=postgresql&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-295-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **197,327** lines in 1,303 files |
| 🧪 &nbsp;Test suite | **4,997+** cases declared in 437 files |
| ⚖️ &nbsp;Test weight | 76,972 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,632 |
| 🐘 &nbsp;SQL migrations | 158, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (58,012 lines) |
...
**Velocity** — v0.232.201, 3,064 commits and 295 releases since 2026-05-14 (127 days, ~24.1 commits/day).

```
commits/week, last 19 weeks   ▁▄▇▆▄▁▃█▄▃▅▆▅▃▃▃▅▁▂   peak 378
```
