...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C295-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C787%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,295** lines in 1,186 files |
| 🧪 &nbsp;Test suite | **3,787+** cases declared in 333 files |
| ⚖️ &nbsp;Test weight | 54,561 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,399 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,350 lines) |
...
**Velocity** — v0.232.116, 2,860 commits and 263 releases since 2026-05-14 (111 days, ~25.8 commits/day).
