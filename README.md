...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-206%2C884-3178c6?logo=typescript&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-328-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **206,884** lines in 1,339 files |
| 🧪 &nbsp;Test suite | **5,257+** cases declared in 460 files |
| ⚖️ &nbsp;Test weight | 81,432 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,684 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,928 lines) |
...
**Velocity** — v0.232.253, 3,195 commits and 328 releases since 2026-05-14 (134 days, ~23.8 commits/day).
