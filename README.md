...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C529-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C746%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-155-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-226-6b4fbb)
![docs](https://img.shields.io/badge/docs-124%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-261-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,529** lines in 1,190 files |
| 🧪 &nbsp;Test suite | **3,746+** cases declared in 328 files |
| ⚖️ &nbsp;Test weight | 54,050 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,398 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,275 lines) |
...
| 🧰 &nbsp;Built-in tools | 226, granted in 57 tool groups |
...
**Velocity** — v0.232.111, 2,849 commits and 261 releases since 2026-05-14 (111 days, ~25.7 commits/day).

```
commits/week, last 16 weeks   ▃▇▆▅▂▂█▄▃▅▇▆▄▄▄▃   peak 358
```
