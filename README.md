...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-179%2C452-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **179,452** lines in 1,140 files |
| 🧪 &nbsp;Test suite | **3,515+** cases declared in 309 files |
| ⚖️ &nbsp;Test weight | 50,297 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,313 |
| 🐘 &nbsp;SQL migrations | 153, replayed in order on every boot |
| 📚 &nbsp;Docs | 120 engineering docs, 77 user-guide pages, 224 changelog entries (55,687 lines) |
...
**Velocity** — v0.232.43, 2,700 commits and 216 releases since 2026-05-14 (101 days, ~26.7 commits/day).
