...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-201%2C171-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C096%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-314-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **201,171** lines in 1,319 files |
| 🧪 &nbsp;Test suite | **5,096+** cases declared in 446 files |
| ⚖️ &nbsp;Test weight | 78,667 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,646 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,381 lines) |
...
**Velocity** — v0.232.225, 3,115 commits and 314 releases since 2026-05-14 (133 days, ~23.4 commits/day).
