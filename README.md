...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-177%2C134-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **177,134** lines in 1,130 files |
| 🧪 &nbsp;Test suite | **3,504+** cases declared in 306 files |
| ⚖️ &nbsp;Test weight | 50,203 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,293 |
| 🐘 &nbsp;SQL migrations | 151, replayed in order on every boot |
| 📚 &nbsp;Docs | 118 engineering docs, 77 user-guide pages, 221 changelog entries (55,420 lines) |
...
**Velocity** — v0.232.32, 2,678 commits and 212 releases since 2026-05-14 (100 days, ~26.8 commits/day).
