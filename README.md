...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-196%2C967-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C987%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-157-336791?logo=postgresql&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-292-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **196,967** lines in 1,297 files |
| 🧪 &nbsp;Test suite | **4,987+** cases declared in 436 files |
| ⚖️ &nbsp;Test weight | 76,746 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,624 |
| 🐘 &nbsp;SQL migrations | 157, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (58,000 lines) |
...
| 🧰 &nbsp;Built-in tools | 245, granted in 57 tool groups |
...
**Velocity** — v0.232.198, 3,058 commits and 292 releases since 2026-05-14 (127 days, ~24.1 commits/day).

```
commits/week, last 19 weeks   ▁▄▇▆▄▂▃█▄▃▅▇▅▄▄▃▆▁▂   peak 371
```
