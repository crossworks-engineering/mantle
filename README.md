...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-210%2C220-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C347%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-164-336791?logo=postgresql&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-333-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **210,220** lines in 1,362 files |
| 🧪 &nbsp;Test suite | **5,347+** cases declared in 477 files |
| ⚖️ &nbsp;Test weight | 83,240 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,732 |
| 🐘 &nbsp;SQL migrations | 164, replayed in order on every boot |
| 📚 &nbsp;Docs | 96 engineering docs, 79 user-guide pages, 224 changelog entries (59,185 lines) |
...
**Velocity** — v0.232.259, 3,226 commits and 333 releases since 2026-05-14 (135 days, ~23.9 commits/day).
