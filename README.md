...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-257%2C818-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C552%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-177-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **257,818** lines in 1,547 files |
| 🧪 &nbsp;Test suite | **3,552+** cases declared in 316 files |
| ⚖️ &nbsp;Test weight | 50,253 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,765 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 216 changelog entries (47,410 lines) |
...
**Velocity** — v0.230.4, 2,443 commits and 177 releases since 2026-05-14 (86 days, ~28.4 commits/day).

```
commits/week, last 13 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅   peak 342
```
