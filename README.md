...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-210%2C330-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C355%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-336-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **210,330** lines in 1,362 files |
| 🧪 &nbsp;Test suite | **5,355+** cases declared in 479 files |
| ⚖️ &nbsp;Test weight | 83,393 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,735 |
| 🐘 &nbsp;SQL migrations | 165, replayed in order on every boot |
| 📚 &nbsp;Docs | 96 engineering docs, 79 user-guide pages, 224 changelog entries (59,208 lines) |
...
**Velocity** — v0.232.262, 3,235 commits and 336 releases since 2026-05-14 (135 days, ~24.0 commits/day).

```
commits/week, last 20 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅▄▃▃▆▁▂▄   peak 343
```
