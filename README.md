...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-171%2C427-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C366%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **171,427** lines in 1,112 files |
| 🧪 &nbsp;Test suite | **3,366+** cases declared in 292 files |
| ⚖️ &nbsp;Test weight | 48,312 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,254 |
...
**Velocity** — v0.232.3, 2,612 commits and 195 releases since 2026-05-14 (98 days, ~26.7 commits/day).
