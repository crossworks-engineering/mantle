...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-184%2C441-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C554%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-231-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **184,441** lines in 1,157 files |
| 🧪 &nbsp;Test suite | **3,554+** cases declared in 312 files |
| ⚖️ &nbsp;Test weight | 50,787 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,339 |
...
**Velocity** — v0.232.65, 2,753 commits and 231 releases since 2026-05-14 (103 days, ~26.7 commits/day).

```
commits/week, last 15 weeks   ▂▇▆▆▂▂█▄▃▅▆▆▄▄▄   peak 355
```
