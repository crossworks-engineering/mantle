...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-201%2C055-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C079%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-312-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **201,055** lines in 1,318 files |
| 🧪 &nbsp;Test suite | **5,079+** cases declared in 444 files |
| ⚖️ &nbsp;Test weight | 78,445 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,643 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,346 lines) |
...
**Velocity** — v0.232.223, 3,110 commits and 312 releases since 2026-05-14 (132 days, ~23.6 commits/day).
