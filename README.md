...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-195%2C742-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C936%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-268-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **195,742** lines in 1,293 files |
| 🧪 &nbsp;Test suite | **4,936+** cases declared in 428 files |
| ⚖️ &nbsp;Test weight | 75,631 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,611 |
| 🐘 &nbsp;SQL migrations | 156, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (57,576 lines) |
...
**Velocity** — v0.232.177, 3,006 commits and 268 releases since 2026-05-14 (116 days, ~25.9 commits/day).

```
commits/week, last 17 weeks   ▁▇▆▇▂▂█▄▃▅▆▇▅▄▄▂▅   peak 342
```
