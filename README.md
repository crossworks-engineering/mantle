...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-169%2C356-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C359%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **169,356** lines in 1,095 files |
| 🧪 &nbsp;Test suite | **3,359+** cases declared in 290 files |
| ⚖️ &nbsp;Test weight | 48,156 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,202 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (53,801 lines) |
...
**Velocity** — v0.230.53, 2,551 commits and 184 releases since 2026-05-14 (92 days, ~27.7 commits/day).
