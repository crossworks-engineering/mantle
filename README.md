...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-256%2C343-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C540%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![docs](https://img.shields.io/badge/docs-115%20guides-4c8eda)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **256,343** lines in 1,539 files |
| 🧪 &nbsp;Test suite | **3,540+** cases declared in 315 files |
| ⚖️ &nbsp;Test weight | 50,095 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,754 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 115 engineering docs, 77 user-guide pages, 216 changelog entries (47,112 lines) |
...
| 🧰 &nbsp;Built-in tools | 197, granted in 52 tool groups |
...
**Velocity** — v0.226.0, 2,413 commits and 175 releases since 2026-05-14 (86 days, ~28.1 commits/day).

```
commits/week, last 13 weeks   ▁▅▇▆▃▁▃█▃▄▅█▄   peak 370
```
