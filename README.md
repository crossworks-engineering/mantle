...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-187%2C078-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C601%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **187,078** lines in 1,173 files |
| 🧪 &nbsp;Test suite | **3,601+** cases declared in 317 files |
| ⚖️ &nbsp;Test weight | 51,582 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,362 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 123 engineering docs, 78 user-guide pages, 224 changelog entries (56,405 lines) |
...
**Velocity** — v0.232.71, 2,766 commits and 236 releases since 2026-05-14 (107 days, ~25.9 commits/day).
