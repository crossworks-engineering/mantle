...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-185%2C288-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C574%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-234-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **185,288** lines in 1,163 files |
| 🧪 &nbsp;Test suite | **3,574+** cases declared in 314 files |
| ⚖️ &nbsp;Test weight | 50,998 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,347 |
...
**Velocity** — v0.232.68, 2,759 commits and 234 releases since 2026-05-14 (104 days, ~26.5 commits/day).

```
commits/week, last 15 weeks   ▃▇▆▅▂▂█▄▃▅▇▆▄▄▄   peak 352
```
