...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-206%2C762-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C254%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **206,762** lines in 1,339 files |
| 🧪 &nbsp;Test suite | **5,254+** cases declared in 460 files |
| ⚖️ &nbsp;Test weight | 81,345 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,682 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,817 lines) |
...
**Velocity** — v0.232.248, 3,183 commits and 327 releases since 2026-05-14 (134 days, ~23.8 commits/day).
