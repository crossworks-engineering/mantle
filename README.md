...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-200%2C067-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C054%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-305-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **200,067** lines in 1,314 files |
| 🧪 &nbsp;Test suite | **5,054+** cases declared in 440 files |
| ⚖️ &nbsp;Test weight | 78,063 lines — 1 for every 2.6 of source |
...
**Velocity** — v0.232.215, 3,094 commits and 305 releases since 2026-05-14 (132 days, ~23.4 commits/day).
