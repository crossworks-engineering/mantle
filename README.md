...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C641-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C892%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-271-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,641** lines in 1,242 files |
| 🧪 &nbsp;Test suite | **3,892+** cases declared in 352 files |
| ⚖️ &nbsp;Test weight | 56,402 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,482 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 93 engineering docs, 79 user-guide pages, 224 changelog entries (57,529 lines) |
...
**Velocity** — v0.232.147, 2,926 commits and 271 releases since 2026-05-14 (112 days, ~26.1 commits/day).

```
commits/week, last 16 weeks   ▄▇▆▄▂▂█▄▃▆▆▅▃▄▄▄   peak 356
```
