...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-207%2C188-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C274%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **207,188** lines in 1,340 files |
| 🧪 &nbsp;Test suite | **5,274+** cases declared in 463 files |
| ⚖️ &nbsp;Test weight | 81,682 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,688 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,952 lines) |
...
**Velocity** — v0.232.255, 3,202 commits and 330 releases since 2026-05-14 (135 days, ~23.7 commits/day).

```
commits/week, last 20 weeks   ▁▅▇▆▃▁▃█▃▄▅█▄▄▃▃▆▁▂▃   peak 370
```
