...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-252%2C092-3178c6?logo=typescript&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-173-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **252,092** lines in 1,512 files |
| 🧪 &nbsp;Test suite | **3,504+** cases declared in 310 files |
| ⚖️ &nbsp;Test weight | 49,707 lines, 1 for every 5.1 of source |
...
**Velocity**: v0.225.0, 2,390 commits and 173 releases since 2026-05-14 (85 days, ~28.1 commits/day).
