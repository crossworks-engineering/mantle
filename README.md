...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C259-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C823%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-273-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,259** lines in 1,248 files |
| 🧪 &nbsp;Test suite | **4,823+** cases declared in 415 files |
| ⚖️ &nbsp;Test weight | 73,475 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,552 |
...
**Velocity** — v0.232.163, 2,975 commits and 273 releases since 2026-05-14 (112 days, ~26.6 commits/day).
