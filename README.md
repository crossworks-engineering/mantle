...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-198%2C885-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C023%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-301-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **198,885** lines in 1,311 files |
| 🧪 &nbsp;Test suite | **5,023+** cases declared in 439 files |
| ⚖️ &nbsp;Test weight | 77,352 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,631 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,268 lines) |
...
**Velocity** — v0.232.210, 3,084 commits and 301 releases since 2026-05-14 (131 days, ~23.5 commits/day).

```
commits/week, last 19 weeks   ▂▇▇▆▂▂█▄▃▅▇▅▄▄▄▃▅▁▂   peak 350
```
