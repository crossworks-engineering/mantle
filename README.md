...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C299-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C834%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-267-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,299** lines in 1,205 files |
| 🧪 &nbsp;Test suite | **3,834+** cases declared in 342 files |
| ⚖️ &nbsp;Test weight | 55,390 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,438 |
...
**Velocity** — v0.232.127, 2,884 commits and 267 releases since 2026-05-14 (112 days, ~25.8 commits/day).
