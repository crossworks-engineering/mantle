...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-182%2C206-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C525%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-220-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **182,206** lines in 1,146 files |
| 🧪 &nbsp;Test suite | **3,525+** cases declared in 311 files |
| ⚖️ &nbsp;Test weight | 50,469 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,321 |
...
**Velocity** — v0.232.53, 2,721 commits and 220 releases since 2026-05-14 (101 days, ~26.9 commits/day).

```
commits/week, last 15 weeks   ▁▇▇▇▂▁▇▆▃▆▆█▆▄▄   peak 312
```
