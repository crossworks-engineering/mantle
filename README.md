...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-256%2C968-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **256,968** lines in 1,542 files |
| 🧪 &nbsp;Test suite | **3,541+** cases declared in 315 files |
| ⚖️ &nbsp;Test weight | 50,105 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,759 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 216 changelog entries (47,332 lines) |
...
**Velocity** — v0.228.0, 2,426 commits and 175 releases since 2026-05-14 (86 days, ~28.2 commits/day).
