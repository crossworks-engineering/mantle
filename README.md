...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-175%2C093-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C472%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-151-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-202-6b4fbb)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **175,093** lines in 1,125 files |
| 🧪 &nbsp;Test suite | **3,472+** cases declared in 303 files |
| ⚖️ &nbsp;Test weight | 49,783 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,280 |
| 🐘 &nbsp;SQL migrations | 151, replayed in order on every boot |
| 📚 &nbsp;Docs | 117 engineering docs, 77 user-guide pages, 219 changelog entries (55,095 lines) |
...
| 🧰 &nbsp;Built-in tools | 202, granted in 53 tool groups |
...
**Velocity** — v0.232.27, 2,664 commits and 212 releases since 2026-05-14 (100 days, ~26.6 commits/day).

```
commits/week, last 15 weeks   ▁▅▇▆▃▁▄█▃▄▅█▅▄▃   peak 357
```
