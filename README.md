...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C039-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C736%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-155-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-225-6b4fbb)
![docs](https://img.shields.io/badge/docs-124%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-256-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,039** lines in 1,189 files |
| 🧪 &nbsp;Test suite | **3,736+** cases declared in 327 files |
| ⚖️ &nbsp;Test weight | 53,912 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,396 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,170 lines) |
...
| 🧰 &nbsp;Built-in tools | 225, granted in 57 tool groups |
...
**Velocity** — v0.232.105, 2,836 commits and 256 releases since 2026-05-14 (110 days, ~25.8 commits/day).

```
commits/week, last 16 weeks   ▂▇▆▆▂▂█▄▃▅▇▆▄▄▄▃   peak 352
```
