...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-210%2C339-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C357%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-337-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **210,339** lines in 1,362 files |
| 🧪 &nbsp;Test suite | **5,357+** cases declared in 480 files |
| ⚖️ &nbsp;Test weight | 83,428 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,736 |
...
**Velocity** — v0.232.263, 3,237 commits and 337 releases since 2026-05-14 (135 days, ~24.0 commits/day).
