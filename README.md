...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-182%2C656-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C535%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-153-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-219-6b4fbb)
![docs](https://img.shields.io/badge/docs-120%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-222-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **182,656** lines in 1,147 files |
| 🧪 &nbsp;Test suite | **3,535+** cases declared in 311 files |
| ⚖️ &nbsp;Test weight | 50,572 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,322 |
| 🐘 &nbsp;SQL migrations | 153, replayed in order on every boot |
| 📚 &nbsp;Docs | 120 engineering docs, 77 user-guide pages, 224 changelog entries (55,739 lines) |
...
| 🧠 &nbsp;Skills | 21 composable behaviours |
| 🧰 &nbsp;Built-in tools | 219, granted in 56 tool groups |
...
**Velocity** — v0.232.56, 2,727 commits and 222 releases since 2026-05-14 (102 days, ~26.7 commits/day).

```
commits/week, last 15 weeks   ▁▇▆▇▂▂█▄▃▅▆▇▅▃▄   peak 342
```
