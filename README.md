...
![tests](https://img.shields.io/badge/tests-3%2C850%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,600** lines in 1,225 files |
| 🧪 &nbsp;Test suite | **3,850+** cases declared in 344 files |
| ⚖️ &nbsp;Test weight | 55,562 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,460 |
...
**Velocity** — v0.232.133, 2,898 commits and 268 releases since 2026-05-14 (112 days, ~25.9 commits/day).
