...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-178%2C466-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C513%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **178,466** lines in 1,133 files |
| 🧪 &nbsp;Test suite | **3,513+** cases declared in 308 files |
| ⚖️ &nbsp;Test weight | 50,267 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,303 |
...
**Velocity** — v0.232.41, 2,696 commits and 216 releases since 2026-05-14 (101 days, ~26.7 commits/day).

```
commits/week, last 15 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅▄▃   peak 340
```
