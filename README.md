...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-175%2C593-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C478%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-151-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-204-6b4fbb)
![docs](https://img.shields.io/badge/docs-117%20guides-4c8eda)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **175,593** lines in 1,126 files |
| 🧪 &nbsp;Test suite | **3,478+** cases declared in 304 files |
| ⚖️ &nbsp;Test weight | 49,862 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,283 |
| 🐘 &nbsp;SQL migrations | 151, replayed in order on every boot |
| 📚 &nbsp;Docs | 117 engineering docs, 77 user-guide pages, 220 changelog entries (55,271 lines) |
...
| 🧰 &nbsp;Built-in tools | 204, granted in 53 tool groups |
...
**Velocity** — v0.232.30, 2,670 commits and 212 releases since 2026-05-14 (100 days, ~26.7 commits/day).
