...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-200%2C890-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C075%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-311-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **200,890** lines in 1,317 files |
| 🧪 &nbsp;Test suite | **5,075+** cases declared in 443 files |
| ⚖️ &nbsp;Test weight | 78,405 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,641 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,324 lines) |
...
**Velocity** — v0.232.222, 3,108 commits and 311 releases since 2026-05-14 (132 days, ~23.5 commits/day).

```
commits/week, last 19 weeks   ▃▇▆▅▂▂█▄▃▅▇▆▄▄▄▃▄▁▂   peak 360
```
