...
![tests](https://img.shields.io/badge/tests-3%2C953%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| 🧪 &nbsp;Test suite | **3,953+** cases declared in 359 files |
| ⚖️ &nbsp;Test weight | 57,450 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,492 |
...
**Velocity** — v0.232.154, 2,940 commits and 273 releases since 2026-05-14 (112 days, ~26.3 commits/day).

```
commits/week, last 16 weeks   ▄▇▆▄▂▃█▄▃▆▆▅▃▄▄▅   peak 348
```
