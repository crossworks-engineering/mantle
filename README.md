...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-196%2C917-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C980%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-283-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **196,917** lines in 1,297 files |
| 🧪 &nbsp;Test suite | **4,980+** cases declared in 435 files |
| ⚖️ &nbsp;Test weight | 76,648 lines — 1 for every 2.6 of source |
...
**Velocity** — v0.232.188, 3,035 commits and 283 releases since 2026-05-14 (125 days, ~24.3 commits/day).
