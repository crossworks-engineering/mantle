...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-189%2C790-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C657%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-240-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **189,790** lines in 1,185 files |
| 🧪 &nbsp;Test suite | **3,657+** cases declared in 322 files |
| ⚖️ &nbsp;Test weight | 52,730 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,383 |
...
**Velocity** — v0.232.82, 2,790 commits and 240 releases since 2026-05-14 (109 days, ~25.6 commits/day).

```
commits/week, last 16 weeks   ▁▇▇▇▂▂█▄▃▅▆▇▅▃▄▂   peak 342
```
