...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-190%2C842-3178c6?logo=typescript&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-247-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **190,842** lines in 1,187 files |
| 🧪 &nbsp;Test suite | **3,685+** cases declared in 324 files |
| ⚖️ &nbsp;Test weight | 53,141 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,388 |
...
**Velocity** — v0.232.92, 2,810 commits and 247 releases since 2026-05-14 (110 days, ~25.5 commits/day).
