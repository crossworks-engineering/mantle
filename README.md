...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-171%2C324-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C361%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-194-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **171,324** lines in 1,112 files |
| 🧪 &nbsp;Test suite | **3,361+** cases declared in 291 files |
| ⚖️ &nbsp;Test weight | 48,231 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,240 |
...
**Velocity** — v0.232.0, 2,606 commits and 194 releases since 2026-05-14 (98 days, ~26.6 commits/day).

```
commits/week, last 14 weeks   ▄▇▆▄▂▃█▄▃▅▆▅▃▄   peak 369
```
