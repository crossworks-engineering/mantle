...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-195%2C475-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C910%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **195,475** lines in 1,293 files |
| 🧪 &nbsp;Test suite | **4,910+** cases declared in 425 files |
| ⚖️ &nbsp;Test weight | 75,106 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,608 |
...
**Velocity** — v0.232.171, 2,994 commits and 275 releases since 2026-05-14 (113 days, ~26.5 commits/day).
