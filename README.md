...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-191%2C862-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C709%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-253-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **191,862** lines in 1,188 files |
| 🧪 &nbsp;Test suite | **3,709+** cases declared in 326 files |
| ⚖️ &nbsp;Test weight | 53,548 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,394 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,160 lines) |
...
**Velocity** — v0.232.100, 2,826 commits and 253 releases since 2026-05-14 (110 days, ~25.7 commits/day).

```
commits/week, last 16 weeks   ▂▇▇▆▂▂█▄▃▅▇▆▄▄▄▂   peak 350
```
