...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-213%2C502-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C419%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-346-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **213,502** lines in 1,389 files |
| 🧪 &nbsp;Test suite | **5,419+** cases declared in 487 files |
| ⚖️ &nbsp;Test weight | 84,857 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,774 |
| 🐘 &nbsp;SQL migrations | 169, replayed in order on every boot |
| 📚 &nbsp;Docs | 96 engineering docs, 79 user-guide pages, 224 changelog entries (59,357 lines) |
...
**Velocity** — v0.232.272, 3,266 commits and 346 releases since 2026-05-14 (136 days, ~24.0 commits/day).
