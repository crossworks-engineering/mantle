...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-208%2C893-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C326%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-161-336791?logo=postgresql&logoColor=white)
![built-in tools](https://img.shields.io/badge/built--in%20tools-248-6b4fbb)
![docs](https://img.shields.io/badge/docs-95%20guides-4c8eda)
![releases](https://img.shields.io/badge/releases-330-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **208,893** lines in 1,351 files |
| 🧪 &nbsp;Test suite | **5,326+** cases declared in 474 files |
| ⚖️ &nbsp;Test weight | 82,769 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,714 |
| 🐘 &nbsp;SQL migrations | 161, replayed in order on every boot |
| 📚 &nbsp;Docs | 95 engineering docs, 79 user-guide pages, 224 changelog entries (59,079 lines) |
...
| 🧰 &nbsp;Built-in tools | 248, granted in 59 tool groups |
| ⚙️ &nbsp;Background AI workers | 13 (extract, summarise, reflect, read, see, speak…) |
| 💾 &nbsp;Datastores | **1** (Postgres — vectors, graph, FTS, queues, realtime, auth) |
| 🧊 &nbsp;Idle footprint | ~2.5 GB RAM, whole stack |

**Velocity** — v0.232.256, 3,216 commits and 330 releases since 2026-05-14 (135 days, ~23.8 commits/day).

```
commits/week, last 20 weeks   ▁▅▇▆▃▁▄█▃▄▅█▅▄▃▃▆▁▂▄   peak 349
```
