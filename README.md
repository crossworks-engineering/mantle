...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-190%2C733-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C684%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-244-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **190,733** lines in 1,187 files |
| 🧪 &nbsp;Test suite | **3,684+** cases declared in 324 files |
| ⚖️ &nbsp;Test weight | 53,099 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,387 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,141 lines) |
...
**Velocity** — v0.232.89, 2,804 commits and 244 releases since 2026-05-14 (110 days, ~25.5 commits/day).
