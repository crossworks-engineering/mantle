...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-171%2C348-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C363%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-195-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **171,348** lines in 1,112 files |
| 🧪 &nbsp;Test suite | **3,363+** cases declared in 291 files |
| ⚖️ &nbsp;Test weight | 48,281 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,253 |
| 🐘 &nbsp;SQL migrations | 150, replayed in order on every boot |
| 📚 &nbsp;Docs | 117 engineering docs, 77 user-guide pages, 217 changelog entries (54,789 lines) |
...
**Velocity** — v0.232.2, 2,610 commits and 195 releases since 2026-05-14 (98 days, ~26.6 commits/day).
