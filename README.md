...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-205%2C150-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C209%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **205,150** lines in 1,330 files |
| 🧪 &nbsp;Test suite | **5,209+** cases declared in 456 files |
| ⚖️ &nbsp;Test weight | 80,805 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,667 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,789 lines) |
...
**Velocity** — v0.232.239, 3,157 commits and 322 releases since 2026-05-14 (133 days, ~23.7 commits/day).
