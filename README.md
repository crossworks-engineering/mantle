...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-191%2C998-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C728%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-255-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **191,998** lines in 1,189 files |
| 🧪 &nbsp;Test suite | **3,728+** cases declared in 327 files |
| ⚖️ &nbsp;Test weight | 53,837 lines — 1 for every 3.6 of source |
...
**Velocity** — v0.232.103, 2,832 commits and 255 releases since 2026-05-14 (110 days, ~25.7 commits/day).
