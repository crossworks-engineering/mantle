...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-194%2C466-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C840%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **194,466** lines in 1,212 files |
| 🧪 &nbsp;Test suite | **3,840+** cases declared in 343 files |
| ⚖️ &nbsp;Test weight | 55,452 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,446 |
...
**Velocity** — v0.232.128, 2,886 commits and 268 releases since 2026-05-14 (112 days, ~25.8 commits/day).
