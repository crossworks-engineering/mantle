...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-168%2C893-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C353%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-184-blue)
...
| 🧪 &nbsp;Test suite | **3,353+** cases declared in 289 files |
| ⚖️ &nbsp;Test weight | 47,990 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,160 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 115 engineering docs, 77 user-guide pages, 217 changelog entries (47,904 lines) |
...
**Velocity** — v0.230.46, 2,537 commits and 184 releases since 2026-05-14 (92 days, ~27.6 commits/day).

```
commits/week, last 14 weeks   ▁▄▇▅▃▁▃█▃▃▅▇▅▄   peak 378
```
