...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-192%2C920-3178c6?logo=typescript&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **192,920** lines in 1,190 files |
| 🧪 &nbsp;Test suite | **3,746+** cases declared in 328 files |
| ⚖️ &nbsp;Test weight | 54,052 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,398 |
| 🐘 &nbsp;SQL migrations | 155, replayed in order on every boot |
| 📚 &nbsp;Docs | 124 engineering docs, 79 user-guide pages, 224 changelog entries (57,302 lines) |
...
| 🧰 &nbsp;Built-in tools | 228, granted in 57 tool groups |
...
**Velocity** — v0.232.112, 2,852 commits and 261 releases since 2026-05-14 (111 days, ~25.7 commits/day).

```
commits/week, last 16 weeks   ▃▇▆▅▂▂█▄▃▅▇▆▄▄▄▃   peak 359
```
