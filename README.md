...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-173%2C461-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C427%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-198-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **173,461** lines in 1,120 files |
| 🧪 &nbsp;Test suite | **3,427+** cases declared in 297 files |
| ⚖️ &nbsp;Test weight | 49,183 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,267 |
...
**Velocity** — v0.232.9, 2,627 commits and 198 releases since 2026-05-14 (98 days, ~26.8 commits/day).
