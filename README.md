...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-212%2C695-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C410%2B%20declared-99424f?logo=vitest&logoColor=white)
![migrations](https://img.shields.io/badge/migrations-168-336791?logo=postgresql&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-345-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **212,695** lines in 1,381 files |
| 🧪 &nbsp;Test suite | **5,410+** cases declared in 485 files |
| ⚖️ &nbsp;Test weight | 84,553 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,763 |
| 🐘 &nbsp;SQL migrations | 168, replayed in order on every boot |
| 📚 &nbsp;Docs | 96 engineering docs, 79 user-guide pages, 224 changelog entries (59,329 lines) |
...
**Velocity** — v0.232.271, 3,263 commits and 345 releases since 2026-05-14 (136 days, ~24.0 commits/day).

```
commits/week, last 20 weeks   ▁▇▇▇▂▁▇▆▃▆▆█▆▄▄▂▆▁▂▅   peak 312
```
