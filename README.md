...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C145-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C880%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-269-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,145** lines in 1,223 files |
| 🧪 &nbsp;Test suite | **3,880+** cases declared in 348 files |
| ⚖️ &nbsp;Test weight | 56,082 lines — 1 for every 3.4 of source |
| 🗂️ &nbsp;Tracked files | 2,459 |
...
**Velocity** — v0.232.140, 2,912 commits and 269 releases since 2026-05-14 (112 days, ~26.0 commits/day).
