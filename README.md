...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-169%2C162-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C340%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-186-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **169,162** lines in 1,098 files |
| 🧪 &nbsp;Test suite | **3,340+** cases declared in 290 files |
| ⚖️ &nbsp;Test weight | 48,002 lines — 1 for every 3.5 of source |
| 🗂️ &nbsp;Tracked files | 2,205 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (53,890 lines) |
...
**Velocity** — v0.230.60, 2,570 commits and 186 releases since 2026-05-14 (93 days, ~27.6 commits/day).
