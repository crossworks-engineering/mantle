...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-193%2C987-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C753%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **193,987** lines in 1,245 files |
| 🧪 &nbsp;Test suite | **4,753+** cases declared in 409 files |
| ⚖️ &nbsp;Test weight | 71,881 lines — 1 for every 2.7 of source |
| 🗂️ &nbsp;Tracked files | 2,543 |
...
**Velocity** — v0.232.160, 2,969 commits and 273 releases since 2026-05-14 (112 days, ~26.5 commits/day).
