...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-258%2C815-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C597%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **258,815** lines in 1,553 files |
| 🧪 &nbsp;Test suite | **3,597+** cases declared in 320 files |
| ⚖️ &nbsp;Test weight | 50,687 lines — 1 for every 5.1 of source |
| 🗂️ &nbsp;Tracked files | 2,719 |
| 🐘 &nbsp;SQL migrations | 147, replayed in order on every boot |
| 📚 &nbsp;Docs | 116 engineering docs, 77 user-guide pages, 217 changelog entries (47,614 lines) |
...
**Velocity** — v0.230.14, 2,464 commits and 178 releases since 2026-05-14 (91 days, ~27.1 commits/day).
