...
![tests](https://img.shields.io/badge/tests-5%2C354%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-334-blue)
...
| 🧪 &nbsp;Test suite | **5,354+** cases declared in 478 files |
| ⚖️ &nbsp;Test weight | 83,364 lines — 1 for every 2.5 of source |
| 🗂️ &nbsp;Tracked files | 2,734 |
...
**Velocity** — v0.232.260, 3,231 commits and 334 releases since 2026-05-14 (135 days, ~23.9 commits/day).

```
commits/week, last 20 weeks   ▁▆▇▇▂▁▆▆▃▅▅█▅▄▃▃▆▁▂▄   peak 346
```
