...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-190%2C081-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-3%2C664%2B%20declared-99424f?logo=vitest&logoColor=white)
...
![releases](https://img.shields.io/badge/releases-242-blue)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **190,081** lines in 1,186 files |
| 🧪 &nbsp;Test suite | **3,664+** cases declared in 323 files |
| ⚖️ &nbsp;Test weight | 52,799 lines — 1 for every 3.6 of source |
| 🗂️ &nbsp;Tracked files | 2,385 |
...
**Velocity** — v0.232.84, 2,794 commits and 242 releases since 2026-05-14 (109 days, ~25.6 commits/day).
