...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-195%2C487-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-4%2C916%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **195,487** lines in 1,293 files |
| 🧪 &nbsp;Test suite | **4,916+** cases declared in 426 files |
| ⚖️ &nbsp;Test weight | 75,240 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,609 |
...
**Velocity** — v0.232.172, 2,996 commits and 275 releases since 2026-05-14 (113 days, ~26.5 commits/day).
