...
![lines of TypeScript](https://img.shields.io/badge/lines%20of%20TypeScript-198%2C404-3178c6?logo=typescript&logoColor=white)
![tests](https://img.shields.io/badge/tests-5%2C016%2B%20declared-99424f?logo=vitest&logoColor=white)
...
| | |
| --- | --- |
| 📐 &nbsp;TypeScript (excl. tests) | **198,404** lines in 1,309 files |
| 🧪 &nbsp;Test suite | **5,016+** cases declared in 439 files |
| ⚖️ &nbsp;Test weight | 77,263 lines — 1 for every 2.6 of source |
| 🗂️ &nbsp;Tracked files | 2,629 |
| 🐘 &nbsp;SQL migrations | 159, replayed in order on every boot |
| 📚 &nbsp;Docs | 94 engineering docs, 79 user-guide pages, 224 changelog entries (58,212 lines) |
...
**Velocity** — v0.232.208, 3,079 commits and 301 releases since 2026-05-14 (131 days, ~23.5 commits/day).
